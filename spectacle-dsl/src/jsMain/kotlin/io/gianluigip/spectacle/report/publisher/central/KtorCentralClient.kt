...
class KtorCentralClient(
    ...
    override suspend fun putSpecs(requestBody: SpecificationsToUpdateRequest) {
    ...
    override suspend fun getWikiPages(source: String): List<WikiPageMetadataResponse> {
        return httpClient.get("${host}api/wiki") {
            parameter("sources", source)
        }.body()
    }

    override suspend fun postWikiPage(wikiPage: WikiPageRequest) {
    ...
    override suspend fun putWikiPage(wikiPage: WikiPageRequest, wikiId: String) {
    ...
    override suspend fun deleteWikiPage(wikiId: String) {
