...
plugins {
    kotlin("js")
    id("io.github.turansky.kfc.webpack") version "5.60.0"
}
...
dependencies {
    ...
    // REACT
    implementation(enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.394-compat"))
